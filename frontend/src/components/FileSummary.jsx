  ...
  return (
    <div>
      <div className='flex flex-col justify-center items-center m-16 p-12 '>
        ...
        <a onAuxClick={handleSubmit} className='flex justify-center items-center h-16 w-64 text-2xl rounded-2xl border-solid border-2 border-black bg-white mt-16 text-black'>GENERATE</a>
      </div>
