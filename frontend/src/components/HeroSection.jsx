        ...
        <section className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="container flex flex-col md:flex-row justify-center items-center mt-32 gap-10 md:gap-40">
                <div className="flex flex-col gap-4 md:order-1 order-2 w-full">
                    <h2 className="text-2xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500 py-2">Summarization made simple with AI.</h2>
                    ...
                    <button className="w-1/2 rounded-lg font-medium text-lg p-2 bg-gradient-to-r from-cyan-500 to-green-500">Get Started - it's free!</button>
                </div>
